...
- Install `copilot-language-server` so Sidekick has an LSP backend available (Mason can grab it quickly) I uninstalled this by the way. Sidekick doesn't need it.
